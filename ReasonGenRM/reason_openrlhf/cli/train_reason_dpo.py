...
from reason_openrlhf.datasets import ReasonDPODataset
from reason_openrlhf.trainer import ReasonDPOTrainer
...
def train(args):
    ...
    train_dataset = ReasonDPODataset(
        train_data,
        tokenizer,
        args.max_len,
        strategy,
