...
from reason_openrlhf.datasets import ReasonSFTDataset
from reason_openrlhf.trainer import ReasonSFTTrainer
...
def train(args):
    ...
    elif 'llama' in args.pretrain.lower():
    ...
    train_dataset = ReasonSFTDataset(
        train_data,
        tokenizer,
        args.max_len,
        strategy,
