...
# SFT Pretrain Model
MODEL_NAME_OR_PATH="${WORK_DIR}/exp/ReasonGenRM-QwQ-32B/zero"

DATASET_DIR=()
while IFS= read -r file; do
    DATASET_DIR+=("$file")
done < <(find "${WORK_DIR}/data/Skywork-Reward-Preference-80K-v0.2/sft/generated_reason" -type f -name "*.jsonl")

OUTPUT_DIR="${WORK_DIR}/data/Skywork-Reward-Preference-80K-v0.2/sft/QwQ-zero"
